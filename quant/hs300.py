...
cor_sec_list = ['000016.SH', '000903.SH', '399905.SZ', '399006.SZ']

stgy = value_stgy.ValueStgy('000300.SH', cor_sec_list, end_date, data_period, correlation_period, shape_period, adf_pvalue=0.5)
