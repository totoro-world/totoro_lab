...
cor_sec_list = ['000016.SH', '000903.SH', '399905.SZ', '000300.SH']

stgy = value_stgy.ValueStgy('399006.SZ', cor_sec_list, end_date, data_period, correlation_period, shape_period, adf_pvalue=0.5)
